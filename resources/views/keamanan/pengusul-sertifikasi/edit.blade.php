...
@section('title','Edit Kelompok Tani Yang Sudah Memiliki Sertifikasi Prima 3')
@section('content')
<div class="main">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card alert">
                    <div class="card-body">
                        <form action="{{ route('pengusul-sertifikasi.update',$data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label>Kelompok Tani</label>
                                <select name="dkt_kelompok_id" class="form-control js-example-basic-single" required>
                                    <option value="{{ $data->dktKelompok->id }}">{{ $data->dktKelompok->nama_dkt }}
                                    </option>
                                    @foreach($dkt as $item)
