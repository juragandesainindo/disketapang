...
@section('title','DATA PANGAN LOKAL DAN OLAHAN')
@section('content')
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <strong style="font-size: 18px;">Tambah Pangan Lokal dan Olahan</strong>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{ route('data-pangan-lokal-store') }}" method="POST" enctype="multipart/form-data">
      	@csrf
	      <div class="modal-body">
		        ...
		        <div class="form-group">
		        	<div class="row">
		        		<div class="col-lg-3">
		        			<strong>Jenis Komoditi</strong>
		        		</div>
		        		<div class="col-lg-9">
		        		    <input type="text"  name="jenis_komoditi" value="{{ old('jenis_komoditi') }}" placeholder="ex: Ubi" class="form-control" required>
		        		</div>
		        	</div>
		        </div>
		        <div class="form-group">
		        	<div class="row">
		        		<div class="col-lg-3">
		        			<strong>Jenis Olahan</strong>
		        		</div>
		        		<div class="col-lg-9">
		        		    <input type="text"  name="jenis_olahan" value="{{ old('jenis_olahan') }}" placeholder="ex: Ubi Kripik" class="form-control" required>
		        		</div>
		        	</div>
		        </div>
		        <div class="form-group">
		        	<div class="row">
		        		<div class="col-lg-3">
		        			<strong>Surat Ijin</strong>
		        		</div>
		        		<div class="col-lg-9">
		        		    <input type="text"  name="surat_ijin" value="{{ old('surat_ijin') }}" class="form-control" required>
		        		</div>
		        	</div>
		        </div>
		        <div class="form-group">
...
<div class="modal fade" id="edit-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <strong style="font-size: 18px;">Edit Pangan Lokal dan Olahan</strong>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{ route('data-pangan-lokal-update',$item->id) }}" method="POST" enctype="multipart/form-data">
      	@csrf
      	@method('PUT')
	      <div class="modal-body">
		        <div class="form-group">
		        ...
		        <div class="form-group">
		        	<div class="row">
		        		...
		        		<div class="col-lg-9">
		        		    <input type="text"  name="jenis_komoditi" value="{{ $item->jenis_komoditi }}" class="form-control" required>
		        		</div>
		        	</div>
		        </div>
		        <div class="form-group">
		        	<div class="row">
		        		...
		        		<div class="col-lg-9">
		        		    <input type="text"  name="jenis_olahan" value="{{ $item->jenis_olahan }}" class="form-control" required>
		        		</div>
		        	</div>
		        </div>
		        <div class="form-group">
		        	<div class="row">
		        		...
		        		<div class="col-lg-9">
		        		    <input type="text"  name="surat_ijin" value="{{ $item->surat_ijin }}" class="form-control" required>
		        		</div>
		        	</div>
		        </div>
		        <div class="form-group">
                ...
                <div class="page-header">
                    <div class="page-title" style="display: flex;justify-content: space-between;align-items: center;">
                    	<label style="margin-top: 10px;">
                    	    ...
                    	    @endif
                    	    <a href="{{ route('data-pangan-lokal-export') }}" class="btn btn-success btn-outline">Export Excel</a>
                        </label>
	                        ...
	                        <table class="table table-striped table-hover">
	                        	...
	                        	<tbody>
	                        		...
	                        		<tr>
	                        			...
	                        			@else
	                        			<td>
	                        				<form action="{{ route('data-pangan-lokal-destroy',$item->id) }}" method="POST" enctype="multipart/form-data">
