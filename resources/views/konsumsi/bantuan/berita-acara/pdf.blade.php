    ...
    <div class="container">
        ...
        <div class="col-md-12 text-justify" style="font-size: 14px;margin-left: 35px;">
            ...
            <table>
                <tr>
                    <td>2.</td>
                    <td>&emsp;&emsp;Nama</td>
                    <td>&emsp;&emsp;&emsp;&emsp;&emsp;: <span style="text-transform: uppercase;">{{ $data->kwtKelompok->ketua }}</span></td>
                </tr>
                <tr>
                    <td></td>
                    <td>&emsp;&emsp;Jabatan</td>
                    <td>&emsp;&emsp;&emsp;&emsp;&emsp;: Ketua Kelompok Tani {{ $data->kwtKelompok->nama_kwt }}</td>
                </tr>
                <tr>
                    <td></td>
                    <td>&emsp;&emsp;Alamat</td>
                    <td>&emsp;&emsp;&emsp;&emsp;&emsp;: {{ $data->kwtKelompok->alamat }}</td>
                </tr>
            </table>
        </div>
        ...
        <div class="row" style="black;margin-top: 30px;">
            <div class="col-md-4 text-left" style="font-size: 14px;">
                ...
                {{$data->kwtKelompok->nama_kwt}}
                <br><br><br><br>
                <div style="text-transform: uppercase;"><b><u>{{$data->kwtKelompok->ketua}}</u></b></div>
            </div>
