<table>
    ...
    <tr>
        <th colspan="2"><b>KELOMPOK WANITA TANI</b></th>
        <th colspan="4"><b>: {{ $data->kwtKelompok->nama_kwt }}</b></th>
    </tr>
    <tr>
        <th colspan="2"><b>KETUA KELOMPOK</b></th>
        <th colspan="4"><b>: {{ $data->kwtKelompok->ketua }}</b></th>
    </tr>
    <tr>
        <th colspan="2"><b>ALAMAT</b></th>
        <th colspan="4"><b>: {{ $data->kwtKelompok->alamat }}</b></th>
    </tr>
    <tr>
        <th colspan="2"><b>PENYULUH LAPANGAN</b></th>
        <th colspan="4"><b>: {{ $data->kwtKelompok->ppl }}</b></th>
    </tr>
    <tr>
        <th></th>
    </tr>
    ...
    <tr>
        ...
        <th colspan="2"></th>
        <th colspan="1">()</th>
        <th colspan="2"><u>{{ $data->kwtKelompok->ppl }}</u></th>
    </tr>
    <tr>
        <th colspan="1">4</th>
        <th colspan="2"></th>
    ...
    <tr>
        ...
        <th colspan="2"></th>
        <th colspan="1">()</th>
        <th colspan="2">Ketua Kelompok Wanita Tani</th>
    </tr>
    <tr>
        <th colspan="1">6</th>
        <th colspan="2"></th>
    ...
    <tr>
        ...
        <th colspan="2"></th>
        <th colspan="1">()</th>
        <th colspan="2"><u>{{ $data->kwtKelompok->ketua }}</u></th>
    </tr>
</table>