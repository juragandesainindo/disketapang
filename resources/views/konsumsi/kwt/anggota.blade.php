...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('kelompok-wanita-tani-anggota.store') }}" method="POST" enctype="multipart/form-data">
      	@csrf
...
<div class="modal fade" id="edit-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('kelompok-wanita-tani-anggota.update',$item->id) }}" method="POST" enctype="multipart/form-data">
      	@csrf
      	@method('PUT')
	      <div class="modal-body">
		        <div class="form-group">
		        ...
		        <div class="form-group">
		        	<div class="row">
		        		...
		        		<div class="col-lg-9">
		        			<input type="text" name="ktp" class="form-control" value="{{ $item->ktp }}" required>
		        		</div>
		        	</div>
		        </div>
		        <div class="form-group">
	                        ...
	                        <table class="table table-striped table-hover" id="table1">
	                        	...
	                        	<tbody>
	                        		...
	                        		<tr>
	                        			...
	                        			@else
	                        			<td>
	                        				<form action="{{ route('kelompok-wanita-tani-anggota.destroy',$item->id) }}" method="POST" enctype="multipart/form-data">
