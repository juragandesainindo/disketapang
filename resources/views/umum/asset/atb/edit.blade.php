                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="nilai_brg" id="nilaiBrg" value="{{ $atb->nilai_brg }}"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="nilai_perolehan" id="nilaiTotal"
                                            value="{{ $atb->nilai_perolehan }}" class="form-control rupiah" type="text"
                                            readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="nilai_surut" id="nilaiSurut" value="{{ $atb->nilai_surut }}"
