...
@section('title','ATB ( Asset Tak Berwujud )')
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <form action="{{ route('asset-tak-berwujud.index') }}" method="GET">
    ...
    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                ...
                <a href="{{ route('asset-tak-berwujud.create') }}" class="btn btn-primary">
                    ...
                    <table id="example" class="table table-striped" style="width:100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ number_format($atb->nilai_surut) }}</td>
                                <td>{{ number_format($atb->nilai_perolehan) }}</td>
                                ...
                                <td>
                                    ...
                                    @else
                                    <a href="{{ asset('umum/asset/atb/'.$atb->foto) }}" target="_blank">
                                        <img src="{{ asset('umum/asset/atb/'.$atb->foto) }}" width="36" height="36"
                                ...
                                <td class="text-center">
                                    <span class="badge bg-primary">
                                        {{ $atb->penanggung_jawab }}
                                    </span>
                                </td>
                                <td>
                                    <a class="btn btn-warning btn-sm"
                                        href="{{ route('asset-tak-berwujud.edit',$atb->id) }}">
                                        <i data-feather="edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#delete-{{ $atb->id }}">
...
<div class="modal fade" id="delete-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('asset-tak-berwujud.destroy',$item->id) }}" method="POST"
