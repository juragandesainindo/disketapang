...
@section('title','Create KIB C ( Gedung & Bangunan )')
...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <form action="{{ route('kib-c.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="kontruksi" value="{{ old('kontruksi') }}"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="tingkat" value="{{ old('tingkat') }}"
                                ...
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="alamat" class="form-control @error('alamat') is-invalid                                
                                                                                                    @enderror"
                                            cols="10" rows="3">{{ old('alamat') }}</textarea>
                                        @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
