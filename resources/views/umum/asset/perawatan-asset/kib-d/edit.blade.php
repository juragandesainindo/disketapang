...
@section('title','Edit Perawatan Asset Kib D')
...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('perawatan-asset-kib-d.index') }}" class="btn btn-secondary"><i
                    data-feather="arrow-left-circle"></i>&nbsp;
                Back
            </a>
        </div>

        <form action="{{ route('perawatan-asset-kib-d.update',$kib->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        <label>Perawatan Kib D &nbsp;<sup class="text-danger">(wajib
                                                diisi)</sup></label>
                                        <select
                ...
                <div class="col-12 col-lg-12">
                    <div class="card flex-fill px-2 pb-2">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Detail Perawatan Asset Kib D</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="fallback">
                                            ...
                                            @else
                                            <a href="{{ asset('umum/asset/perawatan/kib-d/'.$kib->foto) }}"
                                                class="list-group-item mt-2" target="_blank">
                                                <div class="row g-0 align-items-center">
                                                    <div class="col-2">
                                                        <img src="{{ asset('umum/asset/perawatan/kib-d/'.$kib->foto) }}"
