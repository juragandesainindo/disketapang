...
@section('title','Create Perawatan Asset Kib E')
...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <form action="{{ route('perawatan-asset-kib-e.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <option value="{{ old('asset_umum_id') ?? '' }}">{{
                                                old('asset_umum_id') ?? 'Pilih Perawatan Kib E' }}
                                            </option>
