...
<head>
    ...
    <title>Laporan Perawatan Asset Tak Berwujud</title>
...
<body>
    ...
    <table class="table" style="border-collapse: collapse;width:100%;margin-top: 20px;text-align:center;">
        <tr>
            ...
            <th class="th">Barang&nbsp;/&nbsp;Instansi&nbsp;/&nbsp;Developer</th>
        ...
        <tr>
            ...
            <td class="td">{{ $kib->assetUmum->mappingAsset->nama_brg }} <br>
                ( {{ $kib->assetUmum->instansi_developer }} / {{ $kib->assetUmum->nama_developer
                }} )
            </td>
