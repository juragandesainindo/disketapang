...
@section('title','Edit Perawatan Asset Kib B')
...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('perawatan-asset-kib-b.index') }}" class="btn btn-secondary"><i
                    data-feather="arrow-left-circle"></i>&nbsp;
                Back
            </a>
        </div>

        <form action="{{ route('perawatan-asset-kib-b.update',$kib->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                ...
                <div class="col-12 col-lg-12">
                    <div class="card flex-fill px-2 pb-2">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Detail Perawatan Asset Kib B</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="fallback">
                                            ...
                                            @else
                                            <a href="{{ asset('umum/asset/perawatan/kib-b/'.$kib->foto) }}"
                                                class="list-group-item mt-2" target="_blank">
                                                <div class="row g-0 align-items-center">
                                                    <div class="col-2">
                                                        <img src="{{ asset('umum/asset/perawatan/kib-b/'.$kib->foto) }}"
