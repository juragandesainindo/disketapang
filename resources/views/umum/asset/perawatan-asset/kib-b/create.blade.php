...
@section('title','Create Perawatan Asset Kib B')
...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <form action="{{ route('perawatan-asset-kib-b.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <option value="{{ old('asset_umum_pegawai_id') ?? '' }}">{{
                                                old('asset_umum_pegawai_id') ?? 'Pilih Perawatan Kib B' }}
                                            </option>
