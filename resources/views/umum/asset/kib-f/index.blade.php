...
@section('title','KIB F ( Konstruksi Dalam Penggunaan )')
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <form action="{{ route('kib-f.index') }}" method="GET">
    ...
    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                ...
                <a href="{{ route('kib-f.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                    <a href="{{ asset('umum/asset/kib-f/'.$kib->foto) }}" target="_blank">
                                        <img src="{{ asset('umum/asset/kib-f/'.$kib->foto) }}" width="36" height="36"
                                ...
                                <td>
                                    <a class="btn btn-warning btn-sm" href="{{ route('kib-f.edit',$kib->id) }}">
...
<div class="modal fade" id="delete-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('kib-f.destroy',$item->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('DELETE')
                <div class="modal-body">
                    <p>
