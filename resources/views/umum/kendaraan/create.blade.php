                            ...
                            <div class="card flex-fill px-2 pb-2">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @enderror" value="{{ old('tahun_pembuatan') }}">
                                        ...
                                        @enderror" value="{{ old('bahan_bakar') }}">
                                                @error('bahan_bakar')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
