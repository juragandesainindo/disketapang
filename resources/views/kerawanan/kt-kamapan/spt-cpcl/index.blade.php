...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('spt-cpcl.store') }}" method="POST" enctype="multipart/form-data">
      	@csrf
...
<div class="modal fade" id="edit-{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('spt-cpcl.update',$item->id) }}" method="POST" enctype="multipart/form-data">
      	@csrf
      	@method('PUT')
	      <div class="modal-body">
		        <div class="form-group">
	                        ...
	                        <table class="table table-striped table-hover" id="table1">
	                        	...
	                        	<tbody>
	                        	    ...
	                        	    <tr>
	                        		    ...
	                        		    <td><a href="{{ asset('kerawanan/kt-kamapan/spt-cpcl/'.$item->file) }}" target="_blank" class="text-info">{{ $item->file }}</a></td>
	                        		    @if(Auth::user()->role_name=='Kadis Ketapang')
                                        @else
		                        		<td>
		                        			<form action="{{ route('spt-cpcl.destroy',$item->id) }}" method="POST" enctype="multipart/form-data">
