...
<body>
    ...
    <div class="container">
        ...
        <div class="mengetahui text-center mt-5" style="font-size: 14px;">
            ...
            <div class="row">
                <div class="col-md-4">
                    <span>Ketua Kelompok Tani<br>{{ $verifikasi->dktKelompok->nama_dkt }}</span><br><br><br>
                    <span style="text-transform: uppercase;"><b><u>{{ $verifikasi->dktKelompok->ketua }}</u></b></span>
                </div>
                <div class="col-md-4"></div>
                <div class="col-md-4">
                    <span>Penyuluh Pertanian<br>Kelurahan Maharatu</span><br><br><br>
                    <span style="text-transform: uppercase;"><b><u>{{ $verifikasi->dktKelompok->ppl }}</u></b></span>
                </div>
            </div>
        </div>
