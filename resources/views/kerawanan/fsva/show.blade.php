    ...
    <div class="modal-content">
      ...
      <form action="{{ route('peta-fsva.store') }}" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body">
	          <input type="hidden" name="fsva_id" value="{{ $data->id }}">
...
@switch($edit)
@case(1)
@foreach($data->fsvapeta as $item)
<div class="modal fade" id="edit-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <strong style="font-size: 18px;">Edit Peta FSVA</strong>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
	      ...
	      <div class="modal-body">
		        <div class="form-group">
		        	<div class="row">
		        		...
		        		<div class="col-lg-9">
		        			<select name="ket" class="form-control" required>
		        			    <option value="{{ $item->ket }}">{{ $item->ket }}</option>
		        			    <option value="Indeks Ketersediaan">Indeks Ketersediaan</option>
		        			    <option value="Indeks Akses">Indeks Akses</option>
		        			    <option value="Indeks Pemanfaatan">Indeks Pemanfaatan</option>
		        			    <option value="Indeks Komposi">Indeks Komposi</option>
		        ...
		        <div class="form-group">
		        	<div class="row">
		        		...
		        		<div class="col-lg-9">
		        			...
		        			<img src="{{ asset('kerawanan/fsva-peta/'.$item->peta) }}" width="100px" class="m-t-5">
                ...
                <div class="page-header">
                    <div class="page-title" style="display: flex;justify-content: space-between;align-items: center;">
                    	<label style="margin-top: 10px;">
                        	<a href="{{ route('peta-fsva.index') }}" class="btn btn-default btn-outline">Kembali</a>
		    ...
		    <div class="col-lg-12">
                <div class="card alert">
                    <div class="card-header">
                        <h4 style="color:black;">Galeri Image Indeks</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            @foreach($data->fsvapeta as $item)
                            @if($item->ket=='Indeks Ketersediaan')
                            <div class="col-md-4">
                                <div class="thumbnail">
                                    <a href="{{ asset('kerawanan/fsva-peta/'.$item->peta) }}" target="_blank">
                                        <img src="{{ asset('kerawanan/fsva-peta/'.$item->peta) }}" alt="Lights" style="height:200px">
                                        <div class="caption" style="display: flex;justify-content:space-between;align-items:center;">
                                            <p style="color:black;"><strong>{{ $item->ket }}</strong></p>
                                            @if(Auth::user()->role_name=='Kadis Ketapang')
                                            @else
                            ...
                            @endif
                            @if($item->ket=='Indeks Pemanfaatan')
                            <div class="col-md-4">
                                <div class="thumbnail">
                                    <a href="{{ asset('kerawanan/fsva-peta/'.$item->peta) }}" target="_blank">
                                        <img src="{{ asset('kerawanan/fsva-peta/'.$item->peta) }}" alt="Lights" style="height:200px">
