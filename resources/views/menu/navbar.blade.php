<ul>
    <li class="header-icon dib"><img class="avatar-img" src="{{ asset('assets/sitangan2.png') }}" style="width:50px;">
        ...
        <div class="drop-down dropdown-profile">
            ...
            <div class="dropdown-content-body">
                <ul>
                    ...
                    <li><a href="{{ url('panduan-aplikasi') }}" target="_blank"><i class="ti-file"></i> <span>Panduan
                                Aplikasi</span></a></li>
                    {{-- <li><a href="{{ route('change-password') }}" target="_blank"><i class="ti-lock"></i> <span>Ubah
                                Password</span></a></li> --}}
