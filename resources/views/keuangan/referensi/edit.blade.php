...
@section('title','Edit Referensi Tufoksi')
@section('content')
        ...
        <div class="row">
            <div class="col-12 col-lg-12">
                <div class="card flex-fill px-2 pb-2">
                    <form action="{{ route('referensi-tufoksi.update',$referensi->id) }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="nomor_peraturan"
                                    ...
                                    value="{{ old('nomor_peraturan') ?? $referensi->nomor_peraturan }}" autofocus>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="uraian" class="form-control @error('uraian') is-invalid @enderror"
                                    cols="30" rows="5">{{ old('uraian') ?? $referensi->uraian }}</textarea>
                                @error('uraian')
                                <div class="invalid-feedback">
                                    <span class="text-danger">{{ $message }}</span>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="tanggal"
                                    ...
                                    value="{{ old('tanggal') ?? $referensi->tanggal }}">
                                @error('tanggal')
                                <div class="invalid-feedback">
                                    <span class="text-danger">{{ $message }}</span>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="file" name="file"
                                    ...
                                    value="{{ old('file') ?? $referensi->file }}">
                                <embed src="{{ asset('keuangan/referensi/'.$referensi->file) }}" type="">
                                @error('file')
                                <div class="invalid-feedback">
                                    <span class="text-danger">{{ $message }}</span>
                                </div>
