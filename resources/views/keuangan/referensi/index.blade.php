	      ...
	      <div class="modal-body" style="overflow-y: auto;">
		        <div class="form-group">
		        	<div class="row">
		        		...
		        		<div class="col-lg-9">
		        			<input type="text" name="nomor_peraturan" class="form-control" value="{{ old('nomor_peraturan') }}" required>
		        		</div>
		        	</div>
		        </div>
		        <div class="form-group">
...
<div class="modal fade" id="edit-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="color:black;">
      ...
      <form action="{{ route('referensi-tufoksi.update',$item->id) }}" method="POST" enctype="multipart/form-data">
      	@csrf
      	@method('PUT')
	      <div class="modal-body" style="overflow-y: auto;">
		        <div class="form-group">
		        	<div class="row">
		        		...
		        		<div class="col-lg-9">
		        			<input type="text" name="nomor_peraturan" class="form-control" value="{{ $item->nomor_peraturan }}" required>
		        		</div>
		        	</div>
		        </div>
		        <div class="form-group">
		        	<div class="row">
		        		...
		        		<div class="col-lg-9">
		        			<input type="text" name="uraian" class="form-control" value="{{ $item->uraian }}" required>
		        		</div>
		        	</div>
		        </div>
		        <div class="form-group">
	                        		...
	                        		<tr>
	                        			...
	                        			<td>
	                        			    <a href="{{ asset('keuangan/referensi/' . $item->file) }}" target="_blank">
	                        			        <span class="badge badge-primary">{{ Str::limit($item->file, 30) }}</span>
	                        			    </a>
                        			    </td>
                        			    @if(Auth::user()->role_name=='Kadis Ketapang')
                                        @else
	                        			<td>
	                        				<form action="{{ route('referensi-tufoksi.destroy',$item->id) }}" method="POST" enctype="multipart/form-data">
