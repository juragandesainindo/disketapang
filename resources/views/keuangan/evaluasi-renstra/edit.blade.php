...
@section('title','Edit Evaluasi Renstra')
@section('content')
        ...
        <div class="row">
            <div class="col-12 col-lg-12">
                <div class="card flex-fill px-2 pb-2">
                    <form action="{{ route('evaluasi-renstra.update',$renstra->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                @enderror" width="100%">
                                    <option value="{{ $renstra->indikator }}">{{ $renstra->indikator }}</option>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="target"
                                    ...
                                    value="{{ old('target') ?? $renstra->target }}">
                                @error('target')
                                <div class="invalid-feedback">
                                    <span class="text-danger">{{ $message }}</span>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="realisasi"
                                    ...
                                    value="{{ old('realisasi') ?? $renstra->realisasi }}">
                                @error('realisasi')
                                <div class="invalid-feedback">
                                    <span class="text-danger">{{ $message }}</span>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                @enderror" width="100%">
                                    <option value="{{ $renstra->tahun }}">{{ $renstra->tahun }}</option>
                                    @for ($i = $max; $i >= $min; $i--)
