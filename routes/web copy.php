...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::resource('evaluasi-renstra', RenstraController::class);
    Route::get('evaluasi-renstra-export', [RenstraController::class, 'index'])->name('evaluasi-renstra-export');
    Route::post('evaluasi-renstra-search', [RenstraController::class, 'index'])->name('evaluasi-renstra-search');
